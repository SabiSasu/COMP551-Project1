...
# ## Part 1: Split data into train and validation sets
...
# ## Part 2: Compare KNN and Decision Trees

# In[3]:


# KNN regression performance with regions (5-fold cross validation)
region_training = [pd.DataFrame(), pd.DataFrame(), pd.DataFrame(), pd.DataFrame(), pd.DataFrame()]
